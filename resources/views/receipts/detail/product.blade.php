    ...
    <div class="card-body">
        <table class="table table-bordered table-item-receipt" data-product="{{ count($receiptDetails) }}">
            ...
            <tbody>
                ...
                @endforeach
                @for ($i = 0; $i < 20 - count($receiptDetails); $i++)
                    <tr >
                        <td class="text-center align-middle"><span class="stt">1</span></td>
                        <td></td>
                        <td></td>
        ...
        <div class="row align-items-center justify-content-end mb-3">
            ...
            <div class="col-2">
                <span name="tax" class="text-end form-control"> {{ number_format($receipt->consumption_tax) }}
                </span>
            </div>
        </div>
        <div class="row align-items-center justify-content-end mb-3">
            ...
            <div class="col-2">
                <span name="tax" class="text-end form-control"> {{ number_format($receipt->total_receipt_amount) }}
                </span>
            </div>
        </div>
