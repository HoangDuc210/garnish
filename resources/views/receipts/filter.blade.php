<x-form::open :action="route(RECEIPT_ROUTE)" method="GET" class="enter-index-form">
    <div class="card mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col-8">
                ...
                <div class="col-4 align-self-end">
                    <div class="d-grid gap-2 d-md-block">
                        ...
                        <a href="{{ route(RECEIPT_CREATE_ROUTE) }}" class="btn btn-primary btn-icon btn-icon-start w-100 w-md-auto">
