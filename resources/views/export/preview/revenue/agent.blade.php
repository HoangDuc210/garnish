...
@section('content')
    <div class="revenue fs-14">
        <table class="table-head" style="margin-bottom:  15px;">
            <tr>
        ...
        <table class="table-bordered">
            <thead>
                <tr>
                    <th class="w-10" style="padding: 5px">{{ trans('revenue.stt') }}</th>
                    <th class="w-20" style="padding: 5px">{{ trans('revenue.preview.agent.sales_amount') }}</th>
                    <th class="w-20" style="padding: 5px">{{ trans('revenue.preview.agent.quantity') }}</th>
                    <th style="padding: 5px">{{ trans('revenue.remarks') }}</th>
                </tr>
            </thead>
            <tbody>
